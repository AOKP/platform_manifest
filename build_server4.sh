...
. build_release.sh solana "$RELEASE" "$OFFICIAL"

. build_release.sh spyder "$RELEASE" "$OFFICIAL"

. build_release.sh su640 "$RELEASE" "$OFFICIAL"

. build_release.sh t0ltetmo "$RELEASE" "$OFFICIAL"

. build_release.sh targa "$RELEASE" "$OFFICIAL"

. build_release.sh umtsspyder "$RELEASE" "$OFFICIAL"

. build_release.sh vibrantmtd "$RELEASE" "$OFFICIAL"

. build_release.sh vs920 "$RELEASE" "$OFFICIAL"

. build_release.sh yuga "$RELEASE" "$OFFICIAL"
